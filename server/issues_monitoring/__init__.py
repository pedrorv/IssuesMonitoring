...
from .controllers import reset_presencas_meia_noite, checar_condicoes_ambiente, obter_laboratorios_id
...
def run_threads():
    ...
    # Testa por anomalias em cada laboratorio
    lab_ids = obter_laboratorios_id()
    threads_condicoes = []
